...
export default function planned() {
  let initTodo;
  if (localStorage.getItem("importanttodos") === null) {
    initTodo = [];
  } else {
    initTodo = JSON.parse(localStorage.getItem("importanttodos") as string);
  }
  ...
  useEffect(() => {
    localStorage.setItem("importanttodos", JSON.stringify(list));
  }, [list]);
      ...
      <div className="ml-2 mt-8">
        ...
        <div className="mt-5 ">
          <input
            ...
            placeholder="Plese add important task here..."
          />
